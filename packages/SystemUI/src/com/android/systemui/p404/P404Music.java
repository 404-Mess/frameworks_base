...
public class P404Music extends RelativeLayout implements NotificationMediaManager.MediaListener, Palette.PaletteAsyncListener {
   private static final boolean DEBUG = true;
   private static final String TAG = "P404Music";
   ...
   private P404Music mBackground;

   public P404Music(Context context) {
       this(context, null);
   }

   public P404Music(Context context, AttributeSet attrs) {
       this(context, attrs, 0);
   }

   public P404Music(Context context, AttributeSet attrs, int defStyleAttr) {
       this(context, attrs, defStyleAttr, 0);
   }

   public P404Music(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
